 ...
 * diagnósticos/inspeções — hoje só a RDC 275. Fases 8/9 só precisam inserir
 * linhas novas em checklist_modelos/checklist_modelo_versoes; esta query já
 * passa a devolver mais opções sem nenhuma mudança de código.
 */
